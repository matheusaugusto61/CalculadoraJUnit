# **Calculadora JUnit**
> A ideia do projeto é usar o Framework JUnit para criar teste automatizados em java.
...
```
git remote add origin https://github.com/matheusaugusto61/CalculadoraJUnit.git
```
